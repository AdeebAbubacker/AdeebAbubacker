...
<p style="margin-right: 10px"><ul>
  <li> I work as a Flutter Fullstack developer From India. I have the exciting opportunity to be on the cutting edge of mobile application development. In my role, I'm responsible for designing and implementing cross-platform mobile applications using the Flutter framework. This cutting-edge technology allows us to create robust and visually appealing apps for both Android and iOS platforms. I am also proficient in Node.js</li>
</ul></p>
